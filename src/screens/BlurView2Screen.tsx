...
export default class BlurView2Screen extends Component<{}, State> {
  ...
  render() {
    return (
      ...
      >
        ...
        />
        <AnimatedBlurView intensity={this.state.intensity} style={StyleSheet.absoluteFill} tint="default" />
      </View>
    )
  }
