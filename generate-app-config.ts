...
const AppConfig = {
  ...
  expo: {
    ...
    //   infoPlist: {
    //     NSAppleMusicUsageDescription: 'Because we need it',
    //     NSCameraUsageDescription: 'Because we need it',
    //     NSContactsUsageDescription: 'Because we need it',
    //     NSHealthClinicalHealthRecordsShareUsageDescription: 'Because we need it',
    //     NSLocationAlwaysAndWhenInUseUsageDescription: 'Because we need it',
    //     NSLocationAlwaysUsageDescription: 'Because we need it',
    //     NSLocationUsageDescription: 'Because we need it',
    //     NSLocationWhenInUseUsageDescription: 'Because we need it',
    //     NSMicrophoneUsageDescription: 'Because we need it',
    //     NSMotionUsageDescription: 'Because we need it',
    //     NSPhotoLibraryUsageDescription: 'Because we need it',
    //   },
